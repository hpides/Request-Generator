...
class DeserializeAtomTest {
    ...
    fun prepareTest() {
        firstAtomOfFirstStory =
            deserialize(exampleJSON).getStories()[0]!!.atoms[0]
        secondAtomOfFirstStory =
            deserialize(exampleJSON).getStories()[0]!!.atoms[1]
        thirdAtomOfFirstStory =
            deserialize(exampleJSON).getStories()[0]!!.atoms[2]
        seventhAtomOfFirstStory =
            deserialize(exampleJSON).getStories()[0]!!.atoms[6]
        secondAtomOfSecondStory =
            deserialize(exampleJSON).getStories()[1]!!.atoms[3]
