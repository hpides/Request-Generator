...
public class TestRequestHandling extends RequestHandlingFramework {
    ...
    public void testSimpleRequest() throws IOException {
        ...
        val result = rc.getFromEndpoint("TestRequestHandling", null, new URL("http://localhost:9000/"), new HashMap<>());
    ...
    public void testInvalidCharacter() throws IOException {
        ...
        val result = rc.getFromEndpoint("TestRequestHandling", null, new URL("http://localhost:9000/"), params);
        String response = new String(result.getResponse(),StandardCharsets.UTF_8);
    ...
    public void testGETBodyParams() throws IOException {
        ...
        val result = rc.getBodyFromEndpoint("TestRequestHandling", null, new URL("http://localhost:9000/getWithBody"), body);
    ...
    public void testDELETEParams() throws IOException {
        ...
        val params = new HashMap<String,String>();
        params.put("param","value");
        val result = rc.deleteFromEndpoint("TestRequestHandling", null, new URL("http://localhost:9000/"), params);
        assertThat(result.toString(), stringContainsInOrder("param","value"));
    }
    ...
    public void testJSON() throws IOException {
        ...
        val params = new HashMap<String,String>();
        params.put("param","value");
        val result = rc.getFromEndpoint("TestRequestHandling", null, new URL("http://localhost:9000/jsonObject"), params);
    ...
    public void testJSONArray() throws IOException {
        ...
        val params = new HashMap<String,String>();
        params.put("param","value");
        val result = rc.getFromEndpoint("TestRequestHandling", null, new URL("http://localhost:9000/jsonArray"), params);
    ...
    public void testPOSTFormParams() throws IOException {
        ...
        val params = new HashMap<String,String>();
        params.put("param","value");
        val result = rc.postFormToEndpoint("TestRequestHandling", null, new URL("http://localhost:9000/echoPost"), params);
        assertThat(result.toString(), stringContainsInOrder("param = value"));
    }
    @Test
    public void testPUTFormParams() throws IOException {
        ...
        val params = new HashMap<String,String>();
        params.put("param","value");
        val result = rc.putFormToEndpoint("TestRequestHandling", null, new URL("http://localhost:9000/echoPost"), params);
        assertThat(result.toString(), stringContainsInOrder("param = value"));
    }
    ...
    public void testPOSTBodyParams() throws IOException {
        val rc = new RestClient();
        val body = "{\"param\":\"value\"}";
        val result = rc.postBodyToEndpoint("TestRequestHandling", null, new URL("http://localhost:9000/postWithBody"), body);
        assertThat(result.toString(), equalTo(body));
    }
    @Test
    public void testPUTBodyParams() throws IOException {
        val rc = new RestClient();
        val body = "{\"param\":\"value\"}";
        val result = rc.putBodyToEndpoint("TestRequestHandling", null, new URL("http://localhost:9000/postWithBody"), body);
        assertThat(result.toString(), equalTo(body));
    }
    ...
    public void testGETWithAuth() throws IOException {
        val rc = new RestClient();
        val result = rc.getFromEndpointWithAuth("TestRequestHandling", null, new URL("http://localhost:9000/auth"),null,HttpHandlers.AuthHandler.username, HttpHandlers.AuthHandler.password);
    ...
    public void testGETBodyWithAuth() throws IOException {
        val rc = new RestClient();
        val result = rc.getBodyFromEndpointWithAuth("TestRequestHandling", null, new URL("http://localhost:9000/auth"), "\"Something\"", HttpHandlers.AuthHandler.username, HttpHandlers.AuthHandler.password);
    }

    @Test
    public void testDELETEWithAuth() throws IOException {
        val rc = new RestClient();
        val result = rc.deleteFromEndpointWithAuth("TestRequestHandling", null, new URL("http://localhost:9000/auth"),null,HttpHandlers.AuthHandler.username, HttpHandlers.AuthHandler.password);
        assertThat(result.getReturnCode(), equalTo(200));
    }
    @Test
    public void testPOSTBodyWithAuth() throws IOException {
        val rc = new RestClient();
        val result = rc.postBodyToEndpointWithAuth("TestRequestHandling", null, new URL("http://localhost:9000/auth"),"\"Something\"",HttpHandlers.AuthHandler.username, HttpHandlers.AuthHandler.password);
        assertThat(result.getReturnCode(), equalTo(200));
    }
    @Test
    public void testPOSTFormWithAuth() throws IOException {
        val rc = new RestClient();
        val result = rc.postFormToEndpointWithAuth("TestRequestHandling", null, new URL("http://localhost:9000/auth"),new HashMap<>(),HttpHandlers.AuthHandler.username, HttpHandlers.AuthHandler.password);
        assertThat(result.getReturnCode(), equalTo(200));
    }
    @Test
    public void testPUTBodyWithAuth() throws IOException {
        val rc = new RestClient();
        val result = rc.putBodyToEndpointWithAuth("TestRequestHandling", null, new URL("http://localhost:9000/auth"),"\"Something\"",HttpHandlers.AuthHandler.username, HttpHandlers.AuthHandler.password);
        assertThat(result.getReturnCode(), equalTo(200));
    }
    @Test
    public void testPUTFormWithAuth() throws IOException {
        val rc = new RestClient();
        val result = rc.putFormToEndpointWithAuth("TestRequestHandling", null, new URL("http://localhost:9000/auth"),new HashMap<>(),HttpHandlers.AuthHandler.username, HttpHandlers.AuthHandler.password);
        assertThat(result.getReturnCode(), equalTo(200));
    }
    @Test
